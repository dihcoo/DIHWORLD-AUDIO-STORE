...
function renderChapter() {
  ...
  if (activeChapter === "overview") {
    ...
    chapterContent.innerHTML = chapterFrame("08", "FAMILY DOCUMENTS", `${label} downloads`, `<p>The customer manual is the primary companion for ${name}. The technical manual preserves advanced implementation and support detail.</p><div class="document-cards"><a class="primary" href="${manualPath(selected.family, "USER")}" target="_blank"><span>CUSTOMER MANUAL</span><strong>${label}</strong><p>Use cases, controls, signal flow, presets, and practical operation.</p><b>OPEN USER MANUAL ↗</b></a><a href="${manualPath(selected.family, "TECHNICAL")}" target="_blank"><span>ADVANCED / SUPPORT</span><strong>Technical Manual</strong><p>Engineering-facing behavior, implementation notes, and deeper reference.</p><b>OPEN TECHNICAL MANUAL ↗</b></a></div><div class="related-docs"><a href="docs/templates/42_PLUGIN_PLACEMENT_SCHEMATIC.pdf" target="_blank">42-plugin placement schematic ↗</a><a href="docs/guides/PLUGIN_CATEGORY_CHEAT_SHEET.pdf" target="_blank">Plugin category cheat sheet ↗</a><a href="docs/guides/BETTER_BUS_MAP.pdf" target="_blank">Better Bus map ↗</a></div>`);
  } else {
